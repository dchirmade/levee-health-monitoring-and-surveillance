 ...
 * Other sensors could be covered at later stage of project whenever needed
 * 
 * 
 * This is mini standalone version of levee monitoring system. In this version there is no need of 
 * any remote monitoring engine. 
 * 
 */
...
/**
 * 
 * Temporary assignments. Following variables are initialized at the time of sensor deployment.      
 * 
 */

#define ISSTANDALONEMODE 1 
...
void loop( void )
{
  ...
  /** For standalone mode no need to check if remote rule engine has asked for the reading */
  if( ISSTANDALONEMODE || !didLeveeMainEngineAskForTheReading() ) 
  {
